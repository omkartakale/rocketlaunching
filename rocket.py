...
void main()
{
         ...
         i++)
    {
        ...
        line(300, 300-i, 350, 300-i)
        // upper horizon
        line(300, 300-i, 300, 400-i)
        // left vertical

        line(270, 400-i, 380, 400-i)
        // bottom horizon
        line(350, 300-i, 350, 400-i)
        // right vertical

        line(300, 350-i, 270, 400-i)
        // left slant
        line(350, 350-i, 380, 400-i)
        // right slant

        line(300, 300-i, 325, 260-i)
        // top left slant
        line(325, 260-i, 350, 300-i)
        // top right slant

        setcolor(GREEN)
        line(318, 320-i, 335, 320-i)
        // Letter G
